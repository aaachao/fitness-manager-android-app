...
public class kechengtianjia extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getPhoto() {
        FishBun.with(kechengtianjia.this)
...
//                    path = imageData.getStringArrayListExtra(Define.INTENT_PATH);
    ...
    private void regiter() {
        ...
        String url;
        //System.out.println("a.getCoursename="+mingcheng);
       ///System.out.println("a.getCourseteach="+jiaolian);
            url = Constants.BASE_URL + "Course?method=add";
            OkHttpUtils
                    .post()
