...
import com.example.myapplication.example.fragment.ListsikeFragmentbyjiaolian;
...
public class jiaoliandesike extends AppCompatActivity implements View.OnClickListener {

    private Context mContext;
    Intent intent=new Intent();
    private ListuserFragment9 listuserFragment9;
    private ListcourseFragmentbyuser listcourseFragmentbyuser;
    private ListsikeFragmentbyjiaolian listsikeFragmentbyjiaolian;
    ...
    public void onResume(){
        super.onResume();
        listsikeFragmentbyjiaolian=new ListsikeFragmentbyjiaolian();
        //listcourseFragmentbyuser=new ListcourseFragmentbyuser();
        FragmentManager manager=getFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
        transaction.replace(R.id.listyonghu3, listsikeFragmentbyjiaolian);
        transaction.commit();
    }
